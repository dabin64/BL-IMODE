...
function [upperMember lowerMember] = smd1mp(upperDimensions,lowerDimensions)
        
%     r = floor(upperDimensions/2);
%     p = upperDimensions - r;
%     q = lowerDimensions - r;

    upperMember = [zeros(1,2) zeros(1,1)];
    lowerMember = [zeros(1,2) 9.999999*ones(1,1)];
...
function [upperMember lowerMember] = smd2mp(upperDimensions,lowerDimensions)
...
function [upperMember lowerMember] = smd3(upperDimensions,lowerDimensions)
    ...
    upperMember = zeros(1,upperDimensions);
    lowerMember = zeros(1,lowerDimensions);
function [upperMember lowerMember] = smd3mp(upperDimensions,lowerDimensions)
...
function [upperMember lowerMember] = smd4(upperDimensions,lowerDimensions)
    ...
    upperMember = zeros(1,upperDimensions);
    lowerMember = zeros(1,lowerDimensions);
function [upperMember lowerMember] = smd4mp(upperDimensions,lowerDimensions)
...
function [upperMember lowerMember] = smd5mp(upperDimensions,lowerDimensions)
...
%     upperMember = zeros(1,upperDimensions);
%     lowerMember = [ones(1,q) zeros(1,r)];
     upperMember = [zeros(1,1) zeros(1,1)];
     lowerMember = [ones(1,2) 9.999999*ones(1,1)];
function [upperMember lowerMember] = smd6(upperDimensions,lowerDimensions)
    ...
    upperMember = zeros(1,upperDimensions);
    lowerMember = zeros(1,lowerDimensions);
function [upperMember lowerMember] = smd6mp(upperDimensions,lowerDimensions)
...
function [upperMember lowerMember] = smd7(upperDimensions,lowerDimensions)
    ...
    upperMember = zeros(1,upperDimensions);
    lowerMember = [zeros(1,q) ones(1,r)];
function [upperMember lowerMember] = smd7mp(upperDimensions,lowerDimensions)
...
function [upperMember lowerMember] = smd8(upperDimensions,lowerDimensions)
    ...
    upperMember = zeros(1,upperDimensions);
    lowerMember = [ones(1,q) zeros(1,r)];
function [upperMember lowerMember] = smd8mp(upperDimensions,lowerDimensions)
